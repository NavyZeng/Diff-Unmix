...
parser.add_argument('--template', default='dauhst_2stg',
...
parser.add_argument('--batch_size', type=int, default=6, help='the number of HSIs per batch')
parser.add_argument("--max_epoch", type=int, default=3000, help='total epoch')
...
# parser.add_argument("--epoch_sam_num", type=int, default=5000, help='the number of samples per epoch') # Ori
...
# opt.data_path = f"{opt.data_root}/ICVL_data/"
opt.mask_path = f"{opt.data_root}/TSA_simu_data/"
opt.test_path = f"{opt.data_root}/kaist_simu_data/"
